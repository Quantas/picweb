	...
	$query_gallery2 = "SELECT id, name, uid, albumid FROM image WHERE image.albumid = '".$albumid."'";
    ...
    <rss version="2.0" xmlns:media="http://search.yahoo.com/mrss/" 
        ...
        <?php do { ?>
            <item>
                ...
                <link><?php echo "publicget.php?albumid=".$row_gallery2['albumid']."&pic=".$row_gallery2['id'] ?></link>
