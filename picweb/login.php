...
if (isset($_POST['Username:'])) {
  ...
  if ($loginFoundUser) {
	...
	$online_query = "INSERT INTO whos_online (username) VALUES ('$loginUsername')";
	$online = mysql_query($online_query, $picweb) or die(mysql_error());	
...
<center>
<img src="images/picweblogo.jpg" width="300"/>
