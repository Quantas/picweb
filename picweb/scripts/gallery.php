...
function generateGallery($uid, $albumid){
	...
	<?php if (($totalRows_gallery) > '0') {?>
		<?php $count = 0; ?>
		<?php do {?>
		  <?php if ($count > 4) { echo "</tr><tr>"; $count = 0;}?><td><a href="userget.php?albumid=<?php echo $row_albumcheck['id']; ?>&pic=<?php echo $row_gallery['id']; ?>"><img src="thumb.php?id=<?php echo $row_gallery['id']; ?>"></a><br /><a href="userget.php?albumid=<?php echo $row_albumcheck['id']; ?>&pic=<?php echo $row_gallery['id']; ?>"><?php echo $row_gallery['name']; ?></a><?php $count = $count + 1; ?></td>
